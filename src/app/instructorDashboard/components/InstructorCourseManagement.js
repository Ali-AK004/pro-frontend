      ...
      <div className="flex flex-col gap-5">
        {isLoading ? (
          ...
          <div className="col-span-full text-center py-12">
            ...
            <p className="regular-16 text-gray-600 mb-4">لا توجد كورسات للعرض</p>
            <button
              onClick={() => setShowCreateModal(true)}
          ...
          courses.map((course) => (
            <div key={course.id} className="bg-white rounded-lg flex shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-all duration-300">
              {/* Course Image */}
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <p className="regular-12 text-gray-500 mb-1">عدد الطلاب</p>
                    <p className="bold-14 text-gray-900">{selectedCourse.studentCount || 0}</p>
                  </div>
                </div>
              </div>
            </div>
