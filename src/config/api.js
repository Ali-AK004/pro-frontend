...
const getApiConfig = () => {
  ...
  return {
    ...
    // CDN URLs
    cdnBaseURL: process.env.NEXT_PUBLIC_CDN_BASE_URL || 'https://academitna.b-cdn.net',
    cdnImagesURL: process.env.NEXT_PUBLIC_CDN_IMAGES_URL || 'https://academitna.b-cdn.net',
    cdnVideosURL: process.env.NEXT_PUBLIC_CDN_VIDEOS_URL || 'https://academitna.b-cdn.net',
    ...
    // Authentication
    jwtStorageKey: process.env.NEXT_PUBLIC_JWT_STORAGE_KEY || 'academitna_token',
    refreshTokenKey: process.env.NEXT_PUBLIC_REFRESH_TOKEN_KEY || 'academitna_refresh_token',
    sessionTimeout: parseInt(process.env.NEXT_PUBLIC_SESSION_TIMEOUT) || 86400000,
    
    // File upload limits
    maxFileSize: parseInt(process.env.NEXT_PUBLIC_MAX_FILE_SIZE) || 2147483648, // 2GB
    allowedImageTypes: (process.env.NEXT_PUBLIC_ALLOWED_IMAGE_TYPES || 'jpg,jpeg,png,gif,webp').split(','),
    allowedVideoTypes: (process.env.NEXT_PUBLIC_ALLOWED_VIDEO_TYPES || 'mp4,avi,mov,wmv,flv,webm,mkv').split(','),
    allowedDocumentTypes: (process.env.NEXT_PUBLIC_ALLOWED_DOCUMENT_TYPES || 'pdf,doc,docx,txt').split(','),
    ...
    imageCacheDuration: parseInt(process.env.NEXT_PUBLIC_IMAGE_CACHE_DURATION) || 86400000, // 24 hours
  };
};
